...
class AppColors {
  // Soft cream/beige background that reduces eye strain
  static const Color background = Color(0xFFFBF7F0);
  
  // Elegant dark charcoal/brown for typography
  static const Color textPrimary = Color(0xFF2C2520);
  
  // Subtle, refined gold/bronze accents for borders and icons
  static const Color accentGold = Color(0xFFB59A53); 
  static const Color accentGoldLight = Color(0xFFD4C18D);
  static const Color accentGoldDark = Color(0xFF8A7338);
