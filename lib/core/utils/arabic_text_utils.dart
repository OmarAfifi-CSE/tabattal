  ...
  static String removeExtendedUthmaniChars(String text) {
    return text
        ...
        .replaceAll(
          '\u06ED',
          '',
        ) // Removes Arabic Small Low Meem / formatting circle
        .replaceAll(
          '\u06DF',
          '\u0652',
        ) // Small High Rounded Zero -> standard Sukun
        .replaceAll('\u06E0', '') // Small High Upright Rectangular Zero
        .replaceAll(
          '\u06E1',
          '\u0652',
        ); // Dotless Head of Khah -> standard Sukun
  }
...
extension ArabicDigitsStringX on String {
  ...
  String get toArabicDigits =>
      ArabicTextUtils.convertEnglishToArabicDigits(this);
}
