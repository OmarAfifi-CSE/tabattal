...
class QuranAudioManagerViewDesktop extends StatefulWidget {
  ...
  @override
  State<QuranAudioManagerViewDesktop> createState() =>
      _QuranAudioManagerViewDesktopState();
}

class _QuranAudioManagerViewDesktopState
    extends State<QuranAudioManagerViewDesktop> {
              ...
              SliverPadding(
                ...
                sliver: SliverGrid.builder(
                  ...
                  itemBuilder: (context, index) {
                    final surah = index + 1;
                    return _AudioManagerSurahItemDesktop(
                      surah: surah,
...
class _AudioManagerSurahItemDesktop extends StatelessWidget {
  final int surah;
  ...
  const _AudioManagerSurahItemDesktop({
    required this.surah,
