...
import '../../../../quran_video_studio/presentation/widgets/desktop/video_aspect_ratio_bar_desktop.dart';
import '../../../../quran_video_studio/presentation/widgets/shared/video_background_player_view.dart';
import '../../../../quran_video_studio/presentation/widgets/desktop/video_background_selector_desktop.dart';
...
import '../../../../quran_video_studio/presentation/widgets/desktop/video_options_selector_desktop.dart';
...
/// Shows the dedicated Verse Card & Video Studio modal dialog for desktop.
void showVerseCardGeneratorModalDesktop(
  ...
  showDialog(
    ...
    builder: (ctx) => Dialog(
      ...
      child: ConstrainedBox(
        ...
        child: VerseCardGeneratorSheetDesktop(
          verse: verse,
...
class VerseCardGeneratorSheetDesktop extends StatelessWidget {
  ...
  const VerseCardGeneratorSheetDesktop({
    super.key,
    required this.verse,
    this.tafsirText,
...
class _VerseCardGeneratorSheetDesktopContent extends StatefulWidget {
  final VerseModel verse;
  final String? tafsirText;
  final String? translationText;
  final GlobalKey? pageRepaintKey;
  ...
  const _VerseCardGeneratorSheetDesktopContent({
    required this.verse,
    this.tafsirText,
    this.translationText,
    this.pageRepaintKey,
  ...
  @override
  State<_VerseCardGeneratorSheetDesktopContent> createState() =>
      _VerseCardGeneratorSheetDesktopContentState();
}

class _VerseCardGeneratorSheetDesktopContentState
    extends State<_VerseCardGeneratorSheetDesktopContent> {
                                ...
                                Expanded(
                                  child: Scrollbar(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Column(
                                        children: [
                                          _VerseCardFormatSelectorDesktop(
  ...
  Widget _buildPreviewArea(VideoStudioState videoState, {bool isLandscape = false}) {
    switch (_selectedFormat) {
      case ShareFormat.video:
        return KeyedSubtree(
          key: const ValueKey('video_studio_preview_desktop'),
          child: _VideoPreviewViewportDesktop(
            state: videoState,
  ...
  Widget _buildOptionsArea(VideoStudioState videoState) {
    ...
    switch (_selectedFormat) {
      case ShareFormat.video:
        return Column(
          key: const ValueKey('video_options_group_desktop'),
          children: [
            VideoAspectRatioBarDesktop(
            ...
            VideoBackgroundSelectorDesktop(
              config: config,
...
class _VerseCardFormatSelectorDesktop extends StatelessWidget {
  final ShareFormat selectedFormat;
  final ValueChanged<ShareFormat> onFormatChanged;

  const _VerseCardFormatSelectorDesktop({
...
class _FormatTileDesktop extends StatelessWidget {
  final String label;
  final IconData icon;
  final bool isSelected;
  final VoidCallback onTap;

  const _FormatTileDesktop({
    required this.label,
    required this.icon,
...
class _VerseCardActionButtonsDesktop extends StatelessWidget {
  final ShareFormat selectedFormat;
  ...
  const _VerseCardActionButtonsDesktop({
    required this.selectedFormat,
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildButtons() {
      switch (selectedFormat) {
        case ShareFormat.video:
          return Row(
            key: const ValueKey('video_action_buttons_desktop'),
            children: [
              Expanded(
        ...
        case ShareFormat.fullPage:
          return Row(
            key: const ValueKey('image_action_buttons_desktop'),
            children: [
              Expanded(
                child: ElevatedButton.icon(
        ...
        case ShareFormat.text:
          return SizedBox(
            key: const ValueKey('text_action_buttons_desktop'),
            width: MediaQuery.sizeOf(context).width,
            child: ElevatedButton.icon(
...
class _VideoPreviewViewportDesktop extends StatelessWidget {
  ...
  const _VideoPreviewViewportDesktop({
    required this.state,
                          ...
                          RepaintBoundary(
                            child: IgnorePointer(
                              child: VideoBackgroundPlayerView(
                                key: ValueKey('desktop_custom_video_bg_${config.customVideoPath}'),
