              ...
              child: Container(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: (isLoadingTafsir && tafsirText.trim().isEmpty)
                      ? KeyedSubtree(
                          key: const ValueKey('text_tafsir_loading'),
                          child: Center(
                            child: Padding(
                      ...
                      : KeyedSubtree(
                          key: const ValueKey('text_tafsir_loaded'),
                          child: Column(
              ...
              child: Container(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: (isLoadingTranslation && translationText.trim().isEmpty)
                      ? KeyedSubtree(
                          key: const ValueKey('text_translation_loading'),
                          child: Center(
                            child: Padding(
                              padding: EdgeInsets.symmetric(vertical: 8.h),
                              child: CupertinoActivityIndicator(
                      ...
                      : KeyedSubtree(
                          key: const ValueKey('text_translation_loaded'),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.stretch,
                            children: [
                              Align(
