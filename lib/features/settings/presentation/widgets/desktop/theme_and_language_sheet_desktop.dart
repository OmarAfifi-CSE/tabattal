...
/// Dedicated desktop modal for managing App Language, Dark Mode, and Mushaf Color Themes.
void showThemeAndLanguageModalDesktop(BuildContext context) {
  final isLandscape =
        ...
        child: ConstrainedBox(
          ...
          child: ClipRRect(
            ...
            child: MultiBlocProvider(
              ...
              child: const ThemeAndLanguageSheetDesktop(isDialog: true),
            ),
          ),
        ),
      ),
  ...
  showModalBottomSheet(
    ...
    builder: (ctx) => MultiBlocProvider(
      ...
      child: const ThemeAndLanguageSheetDesktop(),
    ),
  );
}

class ThemeAndLanguageSheetDesktop extends StatelessWidget {
  final bool isDialog;

  const ThemeAndLanguageSheetDesktop({
    super.key,
    this.isDialog = false,
  });
...
class _LanguagePillDesktop extends StatelessWidget {
  final String label;
...
/// Dual icon for Desktop Drawer entry representing both Mushaf Appearance and Language.
class ThemeAndLanguageDrawerIconDesktop extends StatelessWidget {
  final double? size;
  const ThemeAndLanguageDrawerIconDesktop({super.key, this.size});
