...
/// Dedicated web modal for managing App Language, Dark Mode, and Mushaf Color Themes.
void showThemeAndLanguageModalWeb(BuildContext context) {
  final isLandscape =
        ...
        child: ConstrainedBox(
          ...
          child: ClipRRect(
            ...
            child: MultiBlocProvider(
              ...
              child: const ThemeAndLanguageSheetWeb(isDialog: true),
            ),
          ),
        ),
      ),
  ...
  showModalBottomSheet(
    ...
    builder: (ctx) => MultiBlocProvider(
      ...
      child: const ThemeAndLanguageSheetWeb(),
    ),
  );
}

class ThemeAndLanguageSheetWeb extends StatelessWidget {
  final bool isDialog;

  const ThemeAndLanguageSheetWeb({
    super.key,
    this.isDialog = false,
  });
...
class _LanguagePillWeb extends StatelessWidget {
  final String label;
...
/// Dual icon for Web Drawer entry representing both Mushaf Appearance and Language.
class ThemeAndLanguageDrawerIconWeb extends StatelessWidget {
  final double? size;
  const ThemeAndLanguageDrawerIconWeb({super.key, this.size});
