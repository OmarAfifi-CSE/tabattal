...
class VideoReciterSelectorDesktop extends StatefulWidget {
  ...
  const VideoReciterSelectorDesktop({
    super.key,
  ...
  @override
  State<VideoReciterSelectorDesktop> createState() =>
      _VideoReciterSelectorDesktopState();
}

class _VideoReciterSelectorDesktopState
    extends State<VideoReciterSelectorDesktop> {
  ...
  @override
  void didUpdateWidget(covariant VideoReciterSelectorDesktop oldWidget) {
  ...
  void _showAllRecitersSheet(BuildContext context) {
    ...
    showDialog(
      context: context,
      builder: (ctx) {
        return _AllRecitersDialogContentDesktop(
...
class _AllRecitersDialogContentDesktop extends StatefulWidget {
  ...
  const _AllRecitersDialogContentDesktop({
  ...
  @override
  State<_AllRecitersDialogContentDesktop> createState() => _AllRecitersDialogContentDesktopState();
}

class _AllRecitersDialogContentDesktopState extends State<_AllRecitersDialogContentDesktop>
