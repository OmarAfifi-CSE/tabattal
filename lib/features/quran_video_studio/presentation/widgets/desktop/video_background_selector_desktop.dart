...
/// Dedicated desktop background selector for video studio.
class VideoBackgroundSelectorDesktop extends StatelessWidget {
  ...
  const VideoBackgroundSelectorDesktop({
    super.key,
