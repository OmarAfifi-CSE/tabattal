...
class QuranTranslationViewWeb extends StatefulWidget {
  final int pageNumber;
  const QuranTranslationViewWeb({super.key, required this.pageNumber});

  @override
  State<QuranTranslationViewWeb> createState() =>
      _QuranTranslationViewWebState();
}
...
class _QuranTranslationViewWebState
    extends State<QuranTranslationViewWeb> {
