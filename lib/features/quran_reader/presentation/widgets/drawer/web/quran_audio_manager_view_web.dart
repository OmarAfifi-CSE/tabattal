...
class QuranAudioManagerViewWeb extends StatefulWidget {
  const QuranAudioManagerViewWeb({super.key});

  @override
  State<QuranAudioManagerViewWeb> createState() =>
      _QuranAudioManagerViewWebState();
}

class _QuranAudioManagerViewWebState
    extends State<QuranAudioManagerViewWeb> {
              ...
              SliverPadding(
                ...
                sliver: SliverGrid.builder(
                  ...
                  itemBuilder: (context, index) {
                    final surah = index + 1;
                    return _AudioManagerSurahItemWeb(
                      surah: surah,
...
class _AudioManagerSurahItemWeb extends StatelessWidget {
  final int surah;
  ...
  const _AudioManagerSurahItemWeb({
    required this.surah,
