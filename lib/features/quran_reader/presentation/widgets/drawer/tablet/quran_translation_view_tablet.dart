...
class QuranTranslationViewTablet extends StatefulWidget {
  ...
  const QuranTranslationViewTablet({super.key, required this.pageNumber});

  @override
  State<QuranTranslationViewTablet> createState() =>
      _QuranTranslationViewTabletState();
}
...
class _QuranTranslationViewTabletState
    extends State<QuranTranslationViewTablet> {
