...
class QuranBookmarksViewTablet extends StatelessWidget {
  const QuranBookmarksViewTablet({super.key});
...
class _EmptyBookmarksViewTablet extends StatelessWidget {
  const _EmptyBookmarksViewTablet();
