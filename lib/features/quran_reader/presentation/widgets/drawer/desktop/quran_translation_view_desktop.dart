...
class QuranTranslationViewDesktop extends StatefulWidget {
  final int pageNumber;
  const QuranTranslationViewDesktop({super.key, required this.pageNumber});

  @override
  State<QuranTranslationViewDesktop> createState() =>
      _QuranTranslationViewDesktopState();
}
...
class _QuranTranslationViewDesktopState
    extends State<QuranTranslationViewDesktop> {
