...
import '../../../pages/search/desktop/quran_search_screen_desktop.dart';
        ...
        slivers: [
          ...
          SliverFillRemaining(
            ...
            final result = await Navigator.push<Map<String, dynamic>>(
              context,
              MaterialPageRoute(builder: (_) => const QuranSearchScreenDesktop()),
            );
            if (result != null) {
            ...
            final result = await Navigator.push<dynamic>(
              context,
              MaterialPageRoute(builder: (_) => const QuranIndexViewDesktop()),
            );
            ...
            final result = await Navigator.push<dynamic>(
              context,
              MaterialPageRoute(builder: (_) => const QuranBookmarksViewDesktop()),
            );
            if (result is Map<String, dynamic>) {
              onNavigateToPage(
                result['page'] as int,
                  ...
                  child: GestureDetector(
                    ...
                    child: Center(
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.swap_horiz_rounded, size: 18.sp, color: isHorizontal ? AppColors.accentGold : AppColors.textPrimary.withValues(alpha: 0.6)),
                          SizedBox(width: 6.w),
                          Text(
                  ...
                  child: GestureDetector(
                    ...
                    child: Center(
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.swap_vert_rounded, size: 18.sp, color: !isHorizontal ? AppColors.accentGold : AppColors.textPrimary.withValues(alpha: 0.6)),
                          SizedBox(width: 6.w),
                          Text(
