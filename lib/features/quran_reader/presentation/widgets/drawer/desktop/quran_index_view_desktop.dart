...
class QuranIndexViewDesktop extends StatefulWidget {
  final int initialIndex;

  const QuranIndexViewDesktop({super.key, this.initialIndex = 0});

  @override
  State<QuranIndexViewDesktop> createState() => _QuranIndexViewDesktopState();
}

class _QuranIndexViewDesktopState extends State<QuranIndexViewDesktop> with SingleTickerProviderStateMixin {
