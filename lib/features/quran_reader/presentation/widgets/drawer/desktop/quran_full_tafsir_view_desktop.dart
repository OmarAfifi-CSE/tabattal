...
class QuranFullTafsirViewDesktop extends StatefulWidget {
  final int pageNumber;
  const QuranFullTafsirViewDesktop({super.key, required this.pageNumber});

  @override
  State<QuranFullTafsirViewDesktop> createState() =>
      _QuranFullTafsirViewDesktopState();
}
...
class _QuranFullTafsirViewDesktopState extends State<QuranFullTafsirViewDesktop> {
