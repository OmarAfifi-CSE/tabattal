...
import '../../../../quran_audio/presentation/widgets/mobile/audio_settings_sheet_mobile.dart';
...
class _VerseActionMenuMobileState extends State<VerseActionMenuMobile>
  ...
  Widget _buildMenuItem(
    ...
    return _VerseActionMenuItemMobile(
      icon: icon,
      text: text,
      iconColor: iconColor,
      onTap: () {
...
class _VerseActionMenuItemMobile extends StatelessWidget {
  final IconData icon;
  final String text;
  final VoidCallback onTap;
  final Color? iconColor;

  const _VerseActionMenuItemMobile({
    required this.icon,
    required this.text,
    required this.onTap,
    this.iconColor,
