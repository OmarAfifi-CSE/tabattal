...
/// Luxury interactive scrollbar and page scrubber tailored for Desktop.
class QuranScrollbarDesktop extends StatefulWidget {
  final int currentPage;
  final MushafTheme mushafTheme;
  final ValueChanged<int> onPageChanged;

  const QuranScrollbarDesktop({
    super.key,
  ...
  @override
  State<QuranScrollbarDesktop> createState() => _QuranScrollbarDesktopState();
}

class _QuranScrollbarDesktopState extends State<QuranScrollbarDesktop> {
  ...
  @override
  void didUpdateWidget(covariant QuranScrollbarDesktop oldWidget) {
