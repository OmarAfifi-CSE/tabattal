...
import '../../../../quran_audio/presentation/widgets/desktop/audio_settings_sheet_desktop.dart';
import '../../../../quran_bookmarks/presentation/bloc/bookmark_bloc.dart';
import '../../../../quran_bookmarks/presentation/bloc/bookmark_event.dart';
...
import '../shared/tafsir_selector_menu.dart';
import 'word_meanings_sheet_desktop.dart';
import '../shared/overlay_position_delegate.dart';
...
class VerseActionMenuDesktop extends StatefulWidget {
  ...
  @override
  State<VerseActionMenuDesktop> createState() => _VerseActionMenuDesktopState();
}

class _VerseActionMenuDesktopState extends State<VerseActionMenuDesktop>
  ...
  Widget _buildMenuItem(
    ...
    return _VerseActionMenuItemDesktop(
      icon: icon,
      text: text,
      iconColor: iconColor,
      onTap: () {
...
class _VerseActionMenuItemDesktop extends StatelessWidget {
  final IconData icon;
  final String text;
  final VoidCallback onTap;
  final Color? iconColor;

  const _VerseActionMenuItemDesktop({
    required this.icon,
    required this.text,
    required this.onTap,
    this.iconColor,
