...
class _VerseActionMenuDesktopState extends State<VerseActionMenuDesktop> with SingleTickerProviderStateMixin {
                          ...
                          return _buildMenuItem(
                            ...
                            () {
                              if (isAudioActive) {
                                ...
                                showAudioSettingsSheetDesktop(context, verseId: widget.verse.id);
                              }
                            },
                          );
                        },
