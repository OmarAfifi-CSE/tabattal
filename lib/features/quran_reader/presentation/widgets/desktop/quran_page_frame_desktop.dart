...
import '../drawer/desktop/quran_index_view_desktop.dart';
...
class QuranPageFrameDesktop extends StatelessWidget {
  final Widget child;
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      final result = await Navigator.push<dynamic>(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              const QuranIndexViewDesktop(initialIndex: 1),
                        ),
                      );
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      final result = await Navigator.push<dynamic>(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              const QuranIndexViewDesktop(initialIndex: 0),
                        ),
                      );
                      if (result != null && onNavigateToPage != null) {
                        if (result is Map<String, dynamic>) {
...
class _DesktopFrameInfoBox extends StatelessWidget {
  final Widget child;
...
class _DesktopHizbMarker extends StatelessWidget {
