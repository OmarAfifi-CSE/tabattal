              ...
              children: [
                ...
                Positioned(
                  ...
                  child: FractionalTranslation(
                    ...
                    child: GestureDetector(
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const QuranIndexViewDesktop(initialIndex: 1))),
                ...
                Positioned(
                  ...
                  child: FractionalTranslation(
                    translation: const Offset(0.0, -0.5),
                    child: GestureDetector(
                      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const QuranIndexViewDesktop(initialIndex: 0))),
                      child: _buildFrameInfoBox(
                        theme: mushafTheme,
                        child: FittedBox(
