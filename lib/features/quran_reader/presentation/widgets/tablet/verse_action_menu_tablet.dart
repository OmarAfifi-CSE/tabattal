...
import '../../../../quran_audio/presentation/widgets/tablet/audio_settings_sheet_tablet.dart';
...
import 'word_meanings_sheet_tablet.dart';
...
class VerseActionMenuTablet extends StatefulWidget {
  ...
  @override
  State<VerseActionMenuTablet> createState() => _VerseActionMenuTabletState();
}

class _VerseActionMenuTabletState extends State<VerseActionMenuTablet>
  ...
  Widget _buildMenuItem(
    ...
    return _VerseActionMenuItemTablet(
      icon: icon,
      text: text,
      iconColor: iconColor,
      onTap: () {
...
class _VerseActionMenuItemTablet extends StatelessWidget {
  final IconData icon;
  final String text;
  final VoidCallback onTap;
  final Color? iconColor;

  const _VerseActionMenuItemTablet({
    required this.icon,
    required this.text,
    required this.onTap,
    this.iconColor,
