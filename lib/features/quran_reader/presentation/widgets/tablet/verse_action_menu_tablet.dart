...
class _VerseActionMenuTabletState extends State<VerseActionMenuTablet> with SingleTickerProviderStateMixin {
                          ...
                          return _buildMenuItem(
                            ...
                            () {
                              if (isAudioActive) {
                                ...
                                showAudioSettingsSheetTablet(context, verseId: widget.verse.id);
                              }
                            },
                          );
                        },
