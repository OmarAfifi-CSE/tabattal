...
class QuranWebPageViewScreen extends StatefulWidget {
  ...
  @override
  State<QuranWebPageViewScreen> createState() => _QuranPageViewScreenState();
}

class _QuranPageViewScreenState extends State<QuranWebPageViewScreen> {
        ...
        child: BlocListener<AudioBloc, AudioState>(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              // On web, use up to 90% of available width capped at 1400px for 2-page mode
              ...
              // Sync scroll positions when crossing the threshold
